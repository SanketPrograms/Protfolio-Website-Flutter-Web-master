...
class PaymentMiddleScreen extends StatelessWidget {
  const PaymentMiddleScreen({Key key}) : super(key: key);
                        ...
                        children: [
                          Expanded(
                            ...
                            child: Column(
                              children: [
                                Text(
                                  "Bank Offer",style: GoogleFonts.poppins(
                                    color: Colors.black,
                                    fontSize: 14,
                                ...
                                Text(
                                  "10% Instant  discount on icici bank credit card and debit cards on a min soend of Rs3000",style: GoogleFonts.poppins(
                                    color: Colors.black,
                                    fontSize: 14,
                                ...
                                Row(mainAxisAlignment: MainAxisAlignment.end,
                                  children: [
                                   Text(
                                        "Know More?",style: GoogleFonts.poppins(
                                          color: Colors.purple,
                                          fontSize: 14,
                                          fontWeight: FontWeight.bold
                                      ),
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        flex: 3,
                        child: Text(
                          "Choose Payment Method",style: GoogleFonts.poppins(
                            color: Colors.black,
                            fontSize: 14,
                            fontWeight: FontWeight.w500
                        ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 20,),
                        Text(
                          "Order Estimate",style: GoogleFonts.poppins(
                        ...
                        Text(
                          "Price Details (item: 1)",style: GoogleFonts.poppins(
                            color: Colors.black,
                            fontSize: 14,
                            fontWeight: FontWeight.bold
                        ),
